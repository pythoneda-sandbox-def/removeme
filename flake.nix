# removeme/flake.nix
#
# This file defines a nix flake for removeme-0.0.0.
#
# GNU GENERAL PUBLIC LICENSE
# Version 3, 29 June 2007
#
# Copyright (C) 2024-today rydnr https://github.com/pythoneda-sandbox/removeme
#
  ...
  outputs = inputs:
    ...
    in flake-utils.lib.eachSystem supportedSystems (system:
      let
        ...
        repo = "removeme";
        version = "0.0.0";
        sha256 = "1w1v5zwd1b08xrc58h6b0dcxnrv61hll8mmlzbdpb6il0fgm3xxv";
        pname = "${org}-${repo}";
        pythonpackage = "pythoneda.sandbox.removeme";
        package = builtins.replaceStrings [ "." ] [ "/" ] pythonpackage;
        entrypoint = "removeme_app";
        description = "test domain";
        ...
        removeme-for = { python , pythoneda-shared-banner , pythoneda-shared-domain  }:
          let
            ...
            banner_file = "${package}/removeme_banner.py";
            banner_class = "removemeBanner";
      ...
      in rec {
        apps = rec {
          default = removeme-default;
          removeme-default = removeme-python311;
          removeme-python38 = shared.app-for {
            package = self.packages.${system}.removeme-python38;
            inherit entrypoint;
          };
          removeme-python39 = shared.app-for {
            package = self.packages.${system}.removeme-python39;
            inherit entrypoint;
          };
          removeme-python310 = shared.app-for {
            package = self.packages.${system}.removeme-python310;
            inherit entrypoint;
          };
          removeme-python311 = shared.app-for {
            package = self.packages.${system}.removeme-python311;
            inherit entrypoint;
          };
        };
        ...
        devShells = rec {
          ...
          removeme-python310 = shared.devShell-for {
            banner = "${
                pythoneda-shared-banner.packages.${system}.pythoneda-shared-banner-python310
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.removeme-python310;
          ...
          removeme-python311 = shared.devShell-for {
            banner = "${
                pythoneda-shared-banner.packages.${system}.pythoneda-shared-banner-python311
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.removeme-python311;
        ...
        packages = rec {
          default = removeme-default;
          removeme-default = removeme-python311;
          removeme-python38 = removeme-for {
            python = pkgs.python38;
          ...
          removeme-python39 = removeme-for {
            python = pkgs.python39;
          ...
          removeme-python310 = removeme-for {
            python = pkgs.python310;
          ...
          removeme-python311 = removeme-for {
            python = pkgs.python311;
